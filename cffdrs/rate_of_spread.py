...
from cffdrs.cfb_calc import critical_surface_intensity, surface_fire_rate_of_spread, crown_fraction_burned
...
def rate_of_spread_extended(fuel_type: FuelType, isi, bui, fmc, sfc, pc, pdf, cc, cbh):
    ...
    if fuel_type == "M1":
        RSI = (pc / 100
               * rate_of_spread("C2", isi, NoBUI, fmc, sfc, pc, pdf, cc, cbh)
               + (100 - pc) / 100
               * rate_of_spread("D1", isi, NoBUI, fmc, sfc, pc, pdf, cc, cbh))
